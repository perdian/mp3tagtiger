...
class ImagesEditorImagePane extends HBox {
    ...
    ImagesEditorImagePane(TagImage image, Localization localization) {
        ...
        descriptionField.textProperty().set(image.descriptionProperty().getValue());
        descriptionField.textProperty().addListener((o, oldValue, newValue) -> image.descriptionProperty().setValue(newValue));
        ...
        pictureTypeBox.valueProperty().set(image.pictureTypeProperty().getValue());
        pictureTypeBox.valueProperty().addListener((o, oldValue, newValue) -> image.pictureTypeProperty().setValue(newValue));
        ...
        removeButton.setGraphic(new ImageView(new Image(ImagesEditorImagePane.class.getClassLoader().getResourceAsStream("icons/16/delete.png"))));
